engine.story({ 
    startBar: {
        ...
        next: ["Wait or go look for him?",
            [.35, .32, "Go look for him", "waitForThomasBar"],
            [.7, .4, "Wait", "lookForThomasStreet"]]
    },
    waitForThomasBar: {
    ...
    aidThomasFastBar: {
        ...
        next: ["What do you do?",
        [.3, .3, "Follow the Woman' aid", "followTheWomanStreet"],
        [.6, .8, "Take Thomas to Doctor", "thomasToDoctor"]]
    },
    waitAndWatchBar: {
        ...
        next: ["What do you do?",
        [.3, .3, "Aid Thomas", "aidThomasSlowBar"],
        [.35, .32, "Follow the Woman", "followTheWomanStreet"]]
    },
    aidThomasSlowBar: {
        ...
        next: ["What do you do?",
        [.3, .3, "Take Thomas to a Doctor", "thomasToDoctor"],
